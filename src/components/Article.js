...
*/
    ...
    getBody() {
        ...
        if (article.loading) return <div key="article!"><h2>{this.context.dictionary.loading}...</h2></div>
        return (
            <div key="article">
                <a href="#" onClick = {this.handleDeleteArticle}>{this.context.dictionary.deleteArticle}</a>
                <p>{article.text}</p>
